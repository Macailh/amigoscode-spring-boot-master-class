...
class CustomerServiceTest {
    ...
    void getCustomers() {
        // given
        Customer jamila = new Customer(1L, "Jamila", "hola123", "jamila@gmail.com");
        Customer ali = new Customer(2L, "Ali", "hola123", "ali@gmail.com");
    ...
    void getCustomer() {
        ...
        assertEquals("hola123", actual.getPassword());
